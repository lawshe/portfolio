workExs = [
  {
    ...
    desc: 'For a peer reviewed bioscience research publisher, converted article full text <a href="https://jats.nlm.nih.gov/" target="_BLANK">JATS XML</a> to JSON, which is used in a <a href="https://www.meteor.com/" target="_BLANK">Meteor</a> template to generate HTML. Article figures are served via a proxy &amp; hosted on <a href="https://aws.amazon.com/s3/" target="_BLANK">AWS S3</a>. The figures are optimized after uploading via <a href="https://aws.amazon.com/lambda/" target="_BLANK">AWS Lambda</a>.'
  },
  {
