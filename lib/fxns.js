Meteor.myFunctions = {
	...
	createProjectLinks: function(){
		$('.section').each(function() {
			...
			$(this).children('.slide').each(function (index) {
				...
				if(project){
					project = '<li><span class="toSlide project-link" data-index="'+index+'">'+project+'</span></li>';
	...
	pageReady: function() {
		...
		$('#fullpage').removeClass('opacity-fix');
		$('.section').removeClass('opacity-fix');
	...
	createFullpage: function(){
		...
		Meteor.myFunctions.createProjectLinks();
